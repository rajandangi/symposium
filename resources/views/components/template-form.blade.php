@props(['method' => 'POST', 'action', 'talk' => new App\Models\Talk()])
    ...
    <form class="space-y-6" method="POST" action="{{ $action }}">
        ...
        <div>
            ...
            <input type="text" id="title" name="title"
                ...
                placeholder="How to save a life" value="{{ old('title', $talk->title) }}">
            ...
            <div>
                ...
                <select id="type" name="type"
                    ...
                    @foreach (App\Enums\TalkType::cases() as $talkType)
                        <option @selected($talkType->value === old('type', $talk->type)) value="{{ $talkType->value }}">
                            {{ ucfirst($talkType->value) }}</option>
                    @endforeach
                </select>
